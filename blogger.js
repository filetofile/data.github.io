...
var PATH = "blogger";
var API_KEY = 'AIzaSyAbxikAscXIcz1T_JPUcaOT4G4n-m4J3C0'; // قم بتعيين المفتاح الخاص بك هنا
...
function submit(method, url) {
    if (dirty) {
        ...
        blog(method, url + '&key=' + API_KEY, {"content": input.value, "title": title.value, "labels": labelList}, function(data) {
            alert("Success!");
            dirty = false;
        });
    } else {
